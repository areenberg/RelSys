...
${OBJECTDIR}/EntireSystem.o: EntireSystem.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EntireSystem.o EntireSystem.cpp
...
${OBJECTDIR}/HeuristicQueue.o: HeuristicQueue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HeuristicQueue.o HeuristicQueue.cpp

${OBJECTDIR}/HyperQueue.o: HyperQueue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HyperQueue.o HyperQueue.cpp
...
${OBJECTDIR}/QueuePerformance.o: QueuePerformance.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QueuePerformance.o QueuePerformance.cpp

${OBJECTDIR}/RelocEvaluation.o: RelocEvaluation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RelocEvaluation.o RelocEvaluation.cpp

${OBJECTDIR}/RelocSimulation.o: RelocSimulation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RelocSimulation.o RelocSimulation.cpp
...
${OBJECTDIR}/eval_time_dep_main.o: eval_time_dep_main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eval_time_dep_main.o eval_time_dep_main.cpp
